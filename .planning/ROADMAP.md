...
- [ ] **Phase 1: Inbound Responses WebSocket** - Deliver authenticated, bounded, cancellable WS transport with focused conformance coverage.
...
|-------|----------------|--------|-----------|
| 1. Inbound Responses WebSocket | 0/TBD | Not started | - |
