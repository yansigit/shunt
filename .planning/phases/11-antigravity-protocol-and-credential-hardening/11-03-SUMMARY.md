...
Additional exact-admission unit coverage is selected by `antigravity_native_affinity`.

Commits: `97ede48 feat(11-03): bind Antigravity account catalog admission`, `ff9f5a2 fix(11-03): enforce exact Antigravity catalog tuples`
